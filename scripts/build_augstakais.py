        ...
        "tasks": [
            {
                ...
                "answer_latex": "(- (2pi)/3 + 2pi*k; (2pi)/3 + 2pi*k)",
        ...
        "tasks": [
            {
                ...
                "answer_latex": "Eksistē x tāds, ka x^2 <= 0 (patiess pie x = 0)",
