...
(() => {
  ...
  const TRANSLATIONS = {
    lv: {
      ...
      self_check_error_hint: '🤔 Pagaidām nesakrīt. Atveriet norādi zemāk un mēģiniet vēlreiz.',
      self_check_error_retry: '🤔 Pagaidām nesakrīt. Pārbaudiet aprēķinus un mēģiniet vēlreiz.',
      self_check_error_open: 'Nesakrīt. Tagad varat atvērt atbildi un atrisinājumu.',
    ...
    ru: {
      ...
      self_check_error_hint: '🤔 Пока не сошлось. Откройте подсказку ниже и попробуйте ещё раз.',
      self_check_error_retry: '🤔 Пока не сошлось. Проверьте вычисления и попробуйте ещё раз.',
      self_check_error_open: 'Не сошлось. Теперь можно открыть ответ и решение.',
