...
(() => {
  ...
  const TRANSLATIONS = {
    lv: {
      ...
      duel_sub: 'Minūte piemēriem — tad nosūti saiti draugam: viņš risinās tos pašus piemērus, un jūs salīdzināsiet rezultātu. Bez reģistrācijas.',
    ...
    ru: {
      ...
      duel_sub: 'Минута на примеры — потом отправь ссылку другу: он решит те же примеры, и вы сравните счёт. Без регистрации.',
