...
(() => {
  ...
  const TRANSLATIONS = {
    lv: {
      ...
      self_check_error_hint: '🤔 Pagaidām nesakrīt. Norāde un atbilde atvērtas zemāk — mēģiniet vēlreiz.',
      self_check_error_retry: '🤔 Pagaidām nesakrīt. Atbilde atvērta zemāk — mēģiniet vēlreiz.',
      self_check_error_open: 'Nesakrīt. Tagad varat atvērt arī atrisinājumu.',
      ...
      reveal_lock_first: 'Norāde un atbilde atvērsies pēc pirmā mēģinājuma, atrisinājums — pēc otrā.',
      reveal_lock_first_nohint: 'Atbilde atvērsies pēc pirmā mēģinājuma, atrisinājums — pēc otrā.',
      reveal_lock_solution: 'Atrisinājums atvērsies pēc vēl viena mēģinājuma.',
    ...
    ru: {
      ...
      self_check_error_hint: '🤔 Пока не сошлось. Подсказка и ответ открыты ниже — попробуйте ещё раз.',
      self_check_error_retry: '🤔 Пока не сошлось. Ответ открыт ниже — попробуйте ещё раз.',
      self_check_error_open: 'Не сошлось. Теперь можно открыть и решение.',
      ...
      reveal_lock_first: 'Подсказка и ответ откроются после первой попытки, решение — после второй.',
      reveal_lock_first_nohint: 'Ответ откроется после первой попытки, решение — после второй.',
      reveal_lock_solution: 'Решение откроется после ещё одной попытки.',
