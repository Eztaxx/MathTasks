...
(() => {
  ...
  const TRANSLATIONS = {
    lv: {
      ...
      nav_lessons: 'Nodarbības',
      nav_lessons_desc: 'Soli pa solim, ar grafikiem',
      lessons_title: 'Nodarbības',
      lessons_lead: 'Īsas nodarbības ar grafikiem: nākamais solis atveras pēc atbildes uz jautājumu.',
      lessons_empty: 'Nodarbību vēl nav.',
      meta_lessons_desc: 'Interaktīvas matemātikas nodarbības ar grafikiem: katrs solis atveras pēc atbildes.',
      lesson_loading: 'Ielādējam nodarbību…',
      lesson_not_found: 'Nodarbība nav atrasta',
      lesson_step_of: 'Solis {n} no {total}',
      lesson_steps_count: 'Soļi: {n}',
      lesson_done_badge: 'Pabeigta',
      lesson_answer_label: 'Jūsu atbilde',
      lesson_check: 'Pārbaudīt',
      lesson_correct: '✓ Pareizi!',
      lesson_wrong: 'Nesakrīt — mēģiniet vēlreiz.',
      lesson_wrong_final: 'Apskatiet skaidrojumu zemāk — un uz priekšu.',
      lesson_continue: 'Skaidrs, tālāk',
      lesson_done_title: 'Nodarbība pabeigta 🎉',
      lesson_done_text: 'Nostipriniet ar tēmas uzdevumiem — tie tiek pārbaudīti automātiski.',
      lesson_go_tasks: 'Uz tēmas uzdevumiem',
      lesson_restart: 'Iziet vēlreiz',
      topic_lesson_btn: 'Nodarbība',
      duel_random: '🎲 Nejaušs pretinieks',
      duel_link_friend: '🔗 Izaicināt draugu ar saiti',
      duel_random_note: 'Meklējam dzīvu pretinieku tiešsaistē, bet, ja neviena nav, tu spēlēsi pret cita spēlētāja ierakstu ar tiem pašiem piemēriem.',
      ...
      duel_invite_score: 'Pretinieka rezultāts atvērsies pēc tava mēģinājuma.',
      duel_friend: 'Draugs',
      ...
      hint_next_step: 'Vēl viena norāde',
      hint_step_of: 'Norāde {n} no {total}',
      hint_steps_done: 'Vairāk norāžu nav — ja joprojām neiznāk, atveriet atbildi.',
    ...
    ru: {
      ...
      nav_lessons: 'Уроки',
      nav_lessons_desc: 'Шаг за шагом, с графиками',
      lessons_title: 'Уроки',
      lessons_lead: 'Короткие уроки с графиками: следующий шаг открывается после ответа на вопрос.',
      lessons_empty: 'Уроков пока нет.',
      meta_lessons_desc: 'Интерактивные уроки математики с графиками: каждый шаг открывается после ответа.',
      lesson_loading: 'Загружаем урок…',
      lesson_not_found: 'Урок не найден',
      lesson_step_of: 'Шаг {n} из {total}',
      lesson_steps_count: 'Шагов: {n}',
      lesson_done_badge: 'Пройден',
      lesson_answer_label: 'Ваш ответ',
      lesson_check: 'Проверить',
      lesson_correct: '✓ Верно!',
      lesson_wrong: 'Не сошлось — попробуйте ещё раз.',
      lesson_wrong_final: 'Посмотрите разбор ниже — и дальше.',
      lesson_continue: 'Понятно, дальше',
      lesson_done_title: 'Урок пройден 🎉',
      lesson_done_text: 'Закрепите на задачах темы — они проверяются автоматически.',
      lesson_go_tasks: 'К задачам темы',
      lesson_restart: 'Пройти заново',
      topic_lesson_btn: 'Урок',
      duel_random: '🎲 Случайный соперник',
      duel_link_friend: '🔗 Вызвать друга по ссылке',
      duel_random_note: 'Ищем живого соперника онлайн, а если никого нет — ты сыграешь против записи другого игрока на тех же примерах.',
      ...
      hint_next_step: 'Ещё подсказка',
      hint_step_of: 'Подсказка {n} из {total}',
      hint_steps_done: 'Больше подсказок нет — если всё равно не выходит, откройте ответ.',
