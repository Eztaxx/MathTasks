...
(() => {
  ...
  const TRANSLATIONS = {
    lv: {
      ...
      next_page: "Nākamā →",
      tasks_shown: "Rāda {shown} no {total}",
      show_more_tasks: "Rādīt vēl {n}",
      show_all_tasks: "Rādīt visus {n}",
    ...
    ru: {
      ...
      nav_exams: 'Экзамены Skola2030',
      nav_exams_desc: 'Подготовка и стратегия',
      ...
      prev_page: "← Назад",
      next_page: "Вперёд →",
      tasks_shown: "Показано {shown} из {total}",
      show_more_tasks: "Показать ещё {n}",
      show_all_tasks: "Показать все {n}",
