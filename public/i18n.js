...
(() => {
  ...
  const TRANSLATIONS = {
    lv: {
      ...
      progress_stat_solved: 'uzdevumi atrisināti',
      progress_stat_solved_sub: 'no {total} vietnē',
      progress_stat_streak: 'dienas pēc kārtas',
      progress_stat_streak_sub: 'labākā sērija — {best}',
      progress_stat_first_try: 'ar pirmo mēģinājumu',
      progress_stat_first_try_sub: '{percent}% no atrisinātajiem',
      progress_stat_topics: 'tēmas apgūtas',
      progress_stat_cw_sub: 'pārbaudes darbi: {count}',
      progress_empty: 'Šeit parādīsies jūsu progress, kad atrisināsiet pirmo uzdevumu.',
      progress_empty_link: 'Izvēlēties tēmu →',
      progress_activity_title: 'Aktivitāte 12 nedēļās',
      ...
      progress_grades_title: 'Pa klasēm',
      progress_grade_topics: 'apgūtas tēmas: {done} no {total}',
      progress_no_grade: 'Bez klases',
    ...
    ru: {
      ...
      progress_stat_solved: 'задач решено',
      progress_stat_solved_sub: 'из {total} на сайте',
      progress_stat_streak: 'дней подряд',
      progress_stat_streak_sub: 'лучшая серия — {best}',
      progress_stat_first_try: 'с первой попытки',
      progress_stat_first_try_sub: '{percent}% решённых',
      progress_stat_topics: 'тем пройдено',
      progress_stat_cw_sub: 'контрольных: {count}',
      progress_empty: 'Здесь появится ваш прогресс, когда вы решите первую задачу.',
      progress_empty_link: 'Выбрать тему →',
      progress_activity_title: 'Активность за 12 недель',
      ...
      progress_grades_title: 'По классам',
      progress_grade_topics: 'тем пройдено: {done} из {total}',
      progress_no_grade: 'Без класса',
