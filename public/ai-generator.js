...
- НА ГЕОМЕТРИЧЕСКИХ ЧЕРТЕЖАХ ПОДПИСЫВАЙ ТОЛЬКО ВЕРШИНЫ заглавными латинскими буквами (A, B, C, D...). Никаких длин, единиц измерения (см, м), углов, «?», «h», «d», «a» и других надписей на геометрическом чертеже быть НЕ должно: все числовые данные строго в тексте условия. Если в условии вершины не названы, чертёж идёт без подписей. Буква вершины — снаружи фигуры рядом с точкой, никогда не на линии: слева от точки text-anchor='end' и x на 8 левее, справа — x на 8 правее, снизу — y на 18 ниже, сверху — y на 8 выше.
- ДЛЯ ГРАФИКОВ, ДИАГРАММ И ЧИСЛОВЫХ ПРЯМЫХ ЧИСЛА ОБЯЗАТЕЛЬНЫ: на осях координат обязательно подписывай стрелки осей x, y, начало координат 0 (или O) и ключевые деления числами (1, 2, -1...), над столбцами диаграмм обязательно подписывай их числовые значения (высоты столбцов), на числовой прямой — значения ключевых точек. Без чисел графики и диаграммы бесполезны.
- Схема, а не масштаб: прямой угол — маленький квадрат в вершине (в том числе у касательной и высоты), точка на отрезке — между его концами. Высоты, медианы и диагонали — пунктиром stroke-dasharray='5 4'.
