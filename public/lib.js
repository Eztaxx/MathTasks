...
(() => {
  ...
  const SIMPLE_UNITS = 'см|мм|дм|км|м|га|кг|мг|г|тонн[аы]?|л|мл|ч|мин|сек|с|руб|евро|долл|доллар[аов]*|гц|квт|вт|cm|mm|dm|km|ha|kg|mg|g|t|ml|min|sec|h|s|hz|eur|usd';
